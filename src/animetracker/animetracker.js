                ...
                <div className='animelist'>
                    {response.data.map((manga) => (
                        <div key={manga.mal_id} className="manga-item">
                            ...
                            <a href={`/${type}/${manga.mal_id}`} target="_blank" rel="noopener noreferrer">
                                <img src={manga.images.jpg.image_url} alt={manga.title_english} />
                            </a>

                            <h3 className="manga-title">English: {manga.title_english}</h3><br />

                            
                            <h3 className="manga-title">Original: {manga.title}</h3><br />
